...
/* package FinallyTagless-0.1.0.0 */
#define VERSION_FinallyTagless "0.1.0.0"
#define MIN_VERSION_FinallyTagless(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "FinallyTagless-0.1.0.0-IYylgWihXo27eRWIlROeOz"

#define CURRENT_PACKAGE_KEY "FinallyTagless-0.1.0.0-IYylgWihXo27eRWIlROeOz"
